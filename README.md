...
During development, the database was modified as the admin features I wanted from a separate table could be achieved using a Boolean "is_admin" attribute in the USER table. 

![database_design_update]()
