...
| Username and password whitespace check   | Notified if the user only enters white space into a box                                                                                            | typed whitespace into each input                  | Given an error message                                                                   | Pass          |
...
| Flash messages for whitespace            | If a user ignores the frontend warnings, submission of the form (with whitespace) results in flash messages saying why the acount wasn't created.  | typed whitespace in username and password boxes   | Flash message stated whitespace not allowed.                                             | Pass          |
...
| Name, Location and review whitespace check | User notified that a field cannot only contain whitespace (or be left blank)                                                                      | Entered spaces into each box                    | Red error div display notifying the user.                                                | Pass          |
...
| Map Marker                                                                      | Moves when the address is inputed                                                                                                                 | Typed in an address                             | Map Marker moves to correct position                                                                           | Pass          |
| Image file                                                                      | Only allows Images to be uploaded                                                                                                                 | Added a PDF to the form                         | Notifed that I must select a file with the format jpeg, jpg or png                                             | Pass          |
| Image View Button                                                               | Allows the user to see a new uploaded image                                                                                                       | Added a new image file and clicked View         | image is displayed on the page                                                                                 | Pass          |
| Flash messages for whitespace                                                   | If a user ignores the frontend warnings, submission of the form (with whitespace) results in flash messages saying why the acount wasn't created. | typed whitespace in username and password boxes | Flash message stated whitespace not allowed.                                                                   | Pass          |
...
|------------------------------|------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|------------------------------------------------------------------------------------------|---------------|
| Input Boxes                  | Notify user input is required                                                                                          | left boxes each box blank and tried to submit           | Red line in the form, if I try to submit I'm notified which part of the form is missing. | Pass          |
| Flash message for whitespace | Submission of the form (with whitespace) results in flash messages saying whitespace not allowed for holiday type name | Typed whitespace in Name box                            | Flash message stated whitespace not allowed.                                             | Pass          |
