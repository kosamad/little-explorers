...
class Holiday(db.Model):
    ...
    holiday_name = db.Column(db.String(15), unique=True, nullable=False)
...
# Methods for password hashing and verification using werkzeug.securtiy
...
class Recommendation(db.Model):
    ...
    holiday_id = db.Column(db.Integer, db.ForeignKey(
        "holiday.id",
        ondelete="CASCADE"),
        nullable=False)
